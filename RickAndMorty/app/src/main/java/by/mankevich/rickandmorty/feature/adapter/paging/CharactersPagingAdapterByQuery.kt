...
class CharactersPagingAdapterByQuery(/*characters: List<CharacterEntity>,*/ private var onItemClick: (CharacterEntity) -> Unit) :
    BasePagingAdapterByQuery<CharacterEntity, CharactersPagingAdapterByQuery.CharacterViewHolder>(/*characters, */
        DIFF_ITEM_CALLBACK
    ) {

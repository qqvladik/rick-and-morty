...
class LocationsAdapter(locations: List<Location>) :
    BaseAdapter<Location, LocationsAdapter.LocationViewHolder>(locations) {
    ...
    inner class LocationViewHolder(resource: Int, parent: ViewGroup, onItemClick: (Location) -> Unit) :
